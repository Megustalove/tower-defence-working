...
// This is the code Shariahar provided for the UI interface along with the  uiHandler js. This code is a complicatedc confusing mess and I would avoid touching it 
...
class CanvasUI {
    constructor(content, config, object, engine) {
        ...
        if (body.fontSize === undefined) body.fontSize = 100;
